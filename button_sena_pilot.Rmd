...
To increase sensitivity of the trial, and to evaluate self-selection bias of authors who opt in to the trial, we will include a measure of methodological quality of the studies under consideration, using a tool developed for this purpose, enabled on an online platform. 
...
Each rater will be introduced to the online tool and then asked to rate x papers. Each paper will be assigned to two independent raters. For each rated item, agreement between raters will evaluated using ?kappa. Sources of disagreement will be discussed between the two raters and one of the course tutors, so that a set of qualitative comments can be collated to consider whether there are any systematic reasons for disagreement. 
